...
add_in = sys.argv[1:] #"/home/zayern/Desktop/Projects/TFSGS/data/DNS_Ali/Sim_1-IC_25/Out_1/" 
print(sys.argv[0])
...
U, V, W, N = data_reshape(add_in[0], Np)

for files in add_in[1:Nprocc]:
    u1, u2, u3, N = data_reshape(files, Np)   
